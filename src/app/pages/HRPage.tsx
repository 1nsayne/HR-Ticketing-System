...
export default function HRPage() {
  ...
  // Calculate KPIs
  const hrTickets = mockTickets.filter((t) => 
    ["Payroll", "Benefits", "Onboarding", "HR"].includes(t.category)
  );
  ...
  const overdueTickets = hrTickets.filter((t) => {
  ...
  const avgResolutionDays = useMemo(() => {
    const resolved = hrTickets.filter(t => t.status === "resolved" || t.status === "closed");
  ...
  const filteredTickets = useMemo(() => {
    let tickets = hrTickets.filter(t => {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                ...
                <p className="text-xl text-gray-700 dark:text-gray-200 max-w-2xl">
                  Manage HR tickets and employee inquiries. Monitor status and resolution times.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <KPICard
              ...
              trend="-0.3 days from last month"
            />
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 mb-12">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-200 mb-8">Visual insights into your HR ticketing performance</p>
              <DashboardGraphs />
            </div>
          </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>Latest 10 filtered HR tickets</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
